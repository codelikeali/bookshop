                    ...
                    <div class="row">
                        <div class="col-lg-7">
                            <div>
                                ...
                                <p class="text-white font-size-2 mb-0">Signup to be the first to hear about exclusive
                                    deals, special offers and upcoming collections</p>
                            </div>
                        </div>
                        <div class="col-lg-5">
                            <div class="pr-lg-10">
                                ...
                                <div class="form-row justify-content-center">
                                    ...
                                    <div class="col-sm-2 ml-2">
                                        <button type="submit"
                                            class="btn btn-dark btn-wide py-2 height-60 font-weight-medium">Subscribe
                                        </button>
                                    </div>
                                </div>
        ...
        <div class="bg-dark space-2 space-lg-3">
            <div class="container">
                <div class="row">
                        ...
                        <div class="pb-md-6">
                            ...
                            <div class="mb-4">
                                <a href="mailto:sale@bookworm.com"
                                    class="font-size-2 d-block text-white mb-1">sale@bookworm.com</a>
                    ...
                    <div class="col-lg-2 mb-5 mb-md-0">
                        <h4 class="font-size-3 font-weight-medium mb-2 mb-xl-5 pb-xl-1 text-gray-500">Customer Service
                        </h4>
                        <ul class="list-unstyled mb-0">
                            <li class="pb-2">
                ...
                <div class="d-lg-flex text-center text-lg-left justify-content-between align-items-center">
                    ...
                    <div class="d-lg-flex justify-content-xl-end align-items-center">
                        ...
                        <select class="js-select selectpicker dropdown-select mb-3 mb-md-0"
                            data-style="text-gray-500 bg-gray-810 px-4 py-2 rounded-md height-5 outline-none shadow-none form-control font-size-2"
