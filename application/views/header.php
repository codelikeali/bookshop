...
<!-- Mirrored from demo2.madrasthemes.com/bookworm-html/redesigned-octo-fiesta/html-demo/home/home-v9.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 20 Jun 2020 16:32:51 GMT -->
                        ...
                        <div class="site-navigation mr-auto d-none d-xl-block">
                            <ul class="nav pl-xl-4">
                                <li class="nav-item dropdown">
                                    <a id="homeDropdownInvoker" href="home"
                                ...
                                <!-- <li class="nav-item">
                                    ...
                                    <div id="featuresDropdownMenu"
                                        ...
                                        aria-labelledby="featuresDropdownInvoker" style="width:100%;">
                                                ...
                                                <div class="banner px-8 py-5">
                                                    <div class="banner__body">
                                                        ...
                                                        <div class="banner__image">
                                                            <img src="<?=base_url();?>assets/img/280x213/img1.png"
                        ...
                        <div class="secondary-navigation">
                            <ul class="nav pr-xl-4">
                                ...
                                <!-- <li class="nav-item"><a href="#"
                                        ...
                                        Seller</a></li>
                                <li class="nav-item"><a href="#"
                                        class="nav-link text-white mx-2 px-0 py-3 font-size-2 font-weight-medium">Trending
                                        Books</a></li>
                                <li class="nav-item"><a href="#"
                                        class="nav-link text-white mx-2 px-0 py-3 font-size-2 font-weight-medium">Gift
                                        Cards</a></li> -->
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="js-scrollbar u-sidebar__body">
                        <div class="u-sidebar__content u-header-sidebar__content">
                                    ...
                                    <form action="login" method="post">
                                        ...
                                        <div class="d-flex justify-content-between mb-5 align-items-center">
                                            ...
                                            <a class="js-animation-link text-dark font-size-2 t-d-u link-muted font-weight-medium"
                                                ...
                                                data-link-group="idForm" data-animation-in="fadeIn"></a>
                                        </div>
                                        <div class="mb-4d75">
                            ...
                            <div id="forgotPassword" style="display: none; opacity: 0;" data-target-group="idForm">
                                ...
                                <header class="border-bottom px-4 px-md-6 py-4">
                                    <h2 class="font-size-3 mb-0 d-flex align-items-center"><i
                                            class="flaticon-question mr-3 font-size-5"></i></h2>
                                </header>
