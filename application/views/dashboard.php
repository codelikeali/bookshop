    ...
    <div class="container">
        <div class="pt-5 pb-5">
            <div class="bg-img-hero img-fluid rounded-md"
                style="background-image: url(<?=base_url();?>assets/img/1400x530/img1.jpg);">
                            ...
                            <div class="media">
                                <div class="media-body align-self-center mb-4 mb-lg-0">
                                    <p class="banner__pretitle text-uppercase text-gray-400 font-weight-bold mb-2"
                                        ...
                                        EDITORS’</p>
                                    <h2 class="font-size-15 mb-3 pb-1" data-scs-animation-in="fadeInUp"
                                        data-scs-animation-delay="300">
                                        <span class="hero__title-line-1 font-weight-normal d-block">Feature Books Of
                                            The </span>
        ...
        <div class="site-search ml-xl-0 ml-md-auto w-r-100 flex-grow-1 mr-md-5 mt-2 mt-md-0 order-1 order-md-0">
            <form class="form-inline my-2 my-xl-0">
                <div class="input-group input-group-borderless w-100">
                    ...
                    <input type="text" id="search_text" class="form-control px-3 bg-gray-200 bg-focus__1"
                        placeholder="Search for books by keyword" aria-label="Amount (to the nearest dollar)">
...
$(document).ready(function() {
    ...
    function load_data(query) {
        $.ajax({
            url: "<?php echo base_url(); ?>dashboard_data",
            method: "POST",
            data: {
                query: query
            },
